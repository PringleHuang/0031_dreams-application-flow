...
ATTACHMENTS_CONFIG: list[dict[str, Any]] = [
    {
        "document_id": "doc_1",
        "document_name": "審訖圖",
        "field_id": "1014650",
